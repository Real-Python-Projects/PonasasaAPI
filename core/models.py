...
class PharmacyProfile(models.Model):
    ...
    health_safety_code = models.CharField(max_length=255,blank=True)
    health_safety_code_doc = models.FileField(max_length=255,blank=True)
    about = models.TextField(max_length=150,blank=True)
    photos = models.ImageField(upload_to='pharmacy',blank=True)
    patners = models.CharField(max_length=255, blank=True)
    coments = models.CharField(max_length=255, blank=True)
    objects=models.Manager()
