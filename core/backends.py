...
class JWTPharmacyOwnerAuthentication(authentication.BaseAuthentication):
    ...
    def _authenticate_credentials(self, request, token):
        ...
        try:
            user = PharmacyOwnerProfile.objects.get(pk=payload['id'])
...
class JWTPharmacistAuthentication(authentication.BaseAuthentication):
    authentication_header_prefix = 'Token'
    ...
    def _authenticate_credentials(self, request, token):
        ...
        try:
            user = PharmacistProfile.objects.get(pk=payload['id'])
