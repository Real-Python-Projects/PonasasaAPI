# Generated by Django 3.2.3 on 2021-06-17 06:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'Super Admin'), (2, ' Pharmacy Owner'), (3, 'Pharmacist')], default=2, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('deliver_information', models.CharField(blank=True, max_length=255, null=True)),
                ('license_number', models.CharField(blank=True, max_length=255, null=True)),
                ('license_number_document', models.FileField(blank=True, null=True, upload_to='')),
                ('health_safety_code', models.CharField(blank=True, max_length=255, null=True)),
                ('health_safety_code_doc', models.FileField(blank=True, max_length=255, null=True, upload_to='')),
                ('about', models.TextField(blank=True, max_length=150, null=True)),
                ('photos', models.ImageField(blank=True, null=True, upload_to='pharmacy')),
                ('patners', models.CharField(blank=True, max_length=255, null=True)),
                ('coments', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pharmacy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.pharmacyprofile')),
            ],
        ),
        migrations.CreateModel(
